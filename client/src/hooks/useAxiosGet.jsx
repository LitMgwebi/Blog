    ...
    useEffect(() => {
        if (id !== null) {
            if (user) {
                axios({
                    method: "GET",
                    url: `https://discount-twitter-api.onrender.com/blog/record/${id}`,
                    headers: {
...
const GetAllSecured = () => {
    ...
    useEffect(() => {
        ...
        if (user) {
            axios({
                method: "GET",
                url: "https://discount-twitter-api.onrender.com/blog/list",
                headers: {
                    'Authorization': `Bearer ${user.token}`
                }
            }).then((res) => {
...
const GetAll = () => {
    ...
    useEffect(() => {
        axios({
            method: "GET",
            url: "https://discount-twitter-api.onrender.com/home/",
        }).then((res) => {
            if (res.data.error != null) {
                    log.error(res.data.error);
                    return;
...
const GetOne = (id) => {
    ...
    useEffect(() => {
        axios({
            method: "GET",
            url: `https://discount-twitter-api.onrender.com/home/${id}`,
        }).then((res) => {
            const updatedPost = {
